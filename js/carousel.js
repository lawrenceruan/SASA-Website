...
// window.initCarousel = initCarousel;
  // Updated carousel.js for absolute positioning
    function initCarousel() {
        ...
        carousels.forEach(carouselContainer => {
            ...
            // Function to update carousel - different from the original!
            function updateCarousel() {
            ...
            // Make sure first slide is active on initialization
        ...
        console.log('All carousels initialized with absolute positioning');
    }

    // Call the function immediately for this example
    initCarousel();